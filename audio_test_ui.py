...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.test_progb.setGeometry(QtCore.QRect(1110, 130, 118, 23))
        ...
        self.test_dur_le.setGeometry(QtCore.QRect(1180, 40, 113, 29))
        ...
        self.test_lb.setGeometry(QtCore.QRect(1180, 80, 113, 29))
        ...
        self.duo_rb.setGeometry(QtCore.QRect(1030, 260, 151, 22))
        self.duo_rb.setObjectName("duo_rb")
        self.log_te = QtWidgets.QTextEdit(self.centralwidget)
        self.log_te.setGeometry(QtCore.QRect(630, 100, 251, 101))
        self.log_te.setObjectName("log_te")
        self.board_selector_pb = QtWidgets.QPushButton(self.centralwidget)
        self.board_selector_pb.setGeometry(QtCore.QRect(1180, 10, 111, 21))
        self.board_selector_pb.setObjectName("board_selector_pb")
        self.widget = QtWidgets.QWidget(self.centralwidget)
        self.widget.setGeometry(QtCore.QRect(1000, 10, 180, 63))
        ...
        self.datacom_cb = QtWidgets.QCheckBox(self.widget)
        self.datacom_cb.setObjectName("datacom_cb")
        self.horizontalLayout.addWidget(self.datacom_cb)
        self.no_audio_cb = QtWidgets.QCheckBox(self.widget)
        self.no_audio_cb.setObjectName("no_audio_cb")
        self.horizontalLayout.addWidget(self.no_audio_cb)
        self.verticalLayout_2.addLayout(self.horizontalLayout)
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.Connect_pb = QtWidgets.QPushButton(self.widget)
        self.Connect_pb.setObjectName("Connect_pb")
        self.horizontalLayout_2.addWidget(self.Connect_pb)
        self.start_test_pb = QtWidgets.QPushButton(self.widget)
        self.start_test_pb.setObjectName("start_test_pb")
        self.horizontalLayout_2.addWidget(self.start_test_pb)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.test_pb.setText(_translate("MainWindow", "Plot data"))
        self.clear_all_b2_pb.setText(_translate("MainWindow", "Clear all"))
        self.clear_all_b1_pb.setText(_translate("MainWindow", "Clear all"))
        self.duo_rb.setText(_translate("MainWindow", "DUO(Deprecated)"))
        self.board_selector_pb.setText(_translate("MainWindow", "Board selector"))
        self.datacom_cb.setText(_translate("MainWindow", "datacom"))
        self.no_audio_cb.setText(_translate("MainWindow", "No Audio"))
